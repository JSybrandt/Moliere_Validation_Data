...
def main():
    realPaths = [
                    "highlyCited.cos.eval",
                    "highlyCited.l2.eval",
                    "highlyCited.tpw.eval",
                    "highlyCited.twe.eval",
                    "highlyCited.hybrid.eval",
                    "highlyCited.path.eval"
                ]
    fakePaths = [
                    "fake.cos.eval",
                    "fake.l2.eval",
...
#    fig.suptitle("", fontsize=16, fontweight='bold')
    ...
    ax.set_title('ROC Highly Cited vs. Noise')
    ax = fig.add_subplot(111)
    ...
    plt.savefig("highly_cited_roc.png")
